...
function VideoCard() {
  return (
    <div className="blob1U5Q left1x3n intro2RCL">
      <div className="grid178A">
        <div>
          <h1>All-in-one bookmark manager</h1>
          <h4 className="my-[1.33em]">Intuitive. Powerful. Runs everywhere</h4>
          <div className="buttons1C0r">
            <a
              data-appearance="primary"
              data-size="big"
              className="buttonYAU- "
              href="https://app.raindrop.io/account/signup"
            >
              Sign up
            </a>
            <a
      ...
      <div className="messageBg3HL1"></div>
    </div>
  );
}
