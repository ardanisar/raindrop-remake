...
function Header() {
  return (
    // <header className="header1jtx" style="--scrollview-inset-value: 0;">
    <header className="header1jtx backdrop-blur-[20px] bg-white/70">
      <div className="contentoxL5 toolbar2CHY">
        ...
        {/* <label className="800px:hidden text-right bg-[#00000014] rounded-[16px] p-[5px_10px] ml-[16px]"> */}
    ...
    // <div className="backdrop-blur-[20px] sticky top-0 z-[9999] bg-white/70">
    //   <div className="mx-auto max-w-[1060px] px-[30px] h-[64px] flex items-center">
    //     {/* <div className="m-auto max-w-[1060px] px-[30px] h-[64px] flex items-center justify-start min-[800px]:justify-between"> */}
    //     {/* logo raindrop */}
    //     <div>
    ...
    //       {/* <menu className="flex items-center mx-[2px] py-[4px] px-[10px] text-[16px] text-[#333333]"> */}
    //       {/* <menu className="flex justify-center"> */}
    //       <li
    //         data-active="false"
    //         className="text-[#333] font-[500] p-[4px_10px] m-[0_2px] rounded-[3px] flex items-center"
    //       >
    //         <a
    //           href="/download"
    //           className="text-[#333] font-[500] p-[4px_10px] m-[0_2px] rounded-[3px] flex items-center"
    ...
    //     </menu>
    //     {/* login */}
    //     <menu className="flex justify-end min-w-[161px] items-center">
    //       <li className="hidden mx-[12px]">
    //         <svg
    //           xmlns="http://www.w3.org/2000/svg"
    //           width="2"
    //           height="17"
    //           viewBox="0 0 2 17"
    //           className="mr-[10px] opacity-[0.9] block fill-current"
    //         >
    //           <path
    //             fillRule="evenodd"
    ...
    //       <li data-active="false">
    //         <a
    //           href="https://app.raindrop.io/account/login"
    //           className="fill-[#333] font-[500] p-[4px_10px] mx-[2px] rounded-[3px] flex items-center"
    //         >
    //           <svg
    //             xmlns="http://www.w3.org/2000/svg"
    //             width="18"
    ...
    //           <a
    //             href="https://app.raindrop.io/account/login"
    //             className="800px:flex justify-end items-center gap-2 hidden"
    //           >
    //             <svg
    //               xmlns="http://www.w3.org/2000/svg"
    //               width="18"
    ...
    //     {/* dropdown navbar */}
    //     <div className="block cursor-default 800px:hidden text-right text-[13px] leading-[1.25] bg-black/10 bg-opacity-75 rounded-[16px] px-[10px] py-[5px] ml-[16px]">
    //       <label>
    //         <select
    //           defaultValue="-1"
    //           className="bg-transparent border-0 font-[500] transform-none font-full m-0 leading[1.15]"
    //         >
