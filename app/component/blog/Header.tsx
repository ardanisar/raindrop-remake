    ...
    <>
      <div className="block bg-white/1 ">
        <div className="sticky top-0 font-[400]">
          ...
          <div className="900px:hidden flex justify-between items-center leading-[20px] h-[41px] border-solid border-[#F2F2F2] border-b-[1px] px-[24px]">
            {/* open in app */}
            <a
              className="900px:hidden flex h-full cursor-pointer m-0 p-0 text-[13px] text-[#6B6B6B] leading-[20px] items-center font-[400] no-underline"
          ...
          <div className="w-full justify-between h-[57px] border-b-[1px] border-[#F2F2F2] px-[24px] items-center flex font-[400]">
            ...
            <div className="flex justify-start">
              ...
              {/* searchbar lengkap */}
              <div className="ml-[24px] hidden md:block">
              ...
              <div className="hidden 900px:block">
                <div className="flex items-center mr-[32px]">
                  <p className="leading-[20px] text-[13px] text-[#6B6B6B] font-[400] m-0">
                    <span>
                      <a
                        className="rounded-[99em] no-underline items-center border-[#4d7aff] border-1 border-solid bg-[#4d7aff] text-white box-border inline-block py-[5px] px-[12px] hover:bg-blue-600 transition-colors"
                        data-testid="headerSignUpButton"
                        href="https://medium.com/m/signin?operation=register&amp;redirect=https%3A%2F%2Fblog.raindrop.io%2F&amp;source=collection_home---two_column_layout_nav-----------------------global_nav------------------"
                        rel="noopener follow"
                      >
