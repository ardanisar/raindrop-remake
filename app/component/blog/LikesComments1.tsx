            ...
            <div className="gap-[16px] items-center flex">
              ...
              <div className="lcb">
                <div className="h-[16px] w-max-[200px] relative items-center flex">
                  ...
                  <a
                    className="z-2 relative flex items-center transition-opacity duration-300 ease-out gap-[16px]"
                    tabIndex={-1}
                    rel="noopener follow"
                    ...
                    <Tooltip text={`${stats.likes} clips`}>
                      <div>
                        <div
                          className="flex"
                          aria-hidden="false"
                          aria-describedby="1266"
                          aria-labelledby="1266"
                        >
