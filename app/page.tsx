  ...
  return (
    <>
      <div className="landing2Gps">
        ...
        {/* <div
        className="mx-auto max-w-[1060px] px-[30px] items-center"
        data-center="true"
      >
        <div className="py-[20px] max-w-[760px] mx-auto">
          <h2 className="mt-[30px] text-[2.25rem] leading-[1.4] mb-[10px] my-[0.83em] font-[600] items-center">
            Designed for ✐&nbsp;creatives, built for <span>{"{"}</span>
            coders<span>{"}"}</span>
          </h2>
          <h4 className="text-[1.5rem] leading-[1.42] font-normal items-center my-[1.33em]">
          ...
          <blockquote className="mx-auto max-w-[630px] text-[1.125rem] leading-[1.45] text-[#666666] items-center m-[1em_40px]">
            We're not trying to reinvent the wheel; we're working on a tool that
            does everything you expect from a <b>modern bookmark manager</b>.
          </blockquote>
        </div>
      </div> */}
        ...
        <div className="contentoxL5 ">
          <div className="columns2vfz">
            <LinkCard
              ...
              text="Want to automatically save your Twitter or Youtube favs? Need more complex integration?
              <br>
            ...
            <LinkCard
              ...
              text=" The entire content of every web-page and PDF that you've saved is fully searchable.
              <br>
        ...
        {/* <div className="my-0 mx-auto max-w-[1060px] py-0 px-[30px]">
          <div className="grid grid-cols-2 gap-x-[100px] pb-[40px] md:grid-cols-1 md:gap-y-[40px]">
        ...
        {/* <div
          className="my-0 mx-auto max-w-[1060px] px-[30px] items-center font-[500]"
          data-center="true"
        >
          <h2 className="mt-[30px] text-center">But wait, there's more</h2>
          <div className="grid lg:grid-cols-3 text-left my-[1.875rem]">
            <span className="flex p-[12px] rounded-[4px]">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
            ...
            <span className="flex p-[12px] rounded-[4px]">
              ...
              <span className="flex-1 ml-[12px]">
                <span className="title-ME6">Batch processing</span>
                <p>
                  Add tags, move or remove multiple flex p-[12px] rounded-[4px]s
                  at once.
                </p>
              </span>
            </span>
            <span className="flex p-[12px] rounded-[4px]">
              ...
              <span className="flex-1 ml-[12px]">
                <span className="title-ME6">Manual sorting</span>
                <p>
                  Arrange flex p-[12px] rounded-[4px]s in whatever way makes
