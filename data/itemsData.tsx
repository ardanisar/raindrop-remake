...
export const itemsData1: Item[] = [
  {
    ...
    image: "/images/collections-1056-bc265944ca9b9cda52c809eb2a85e233.png",
    imageSet:
    ...
    link: "https://help.raindrop.io/collections",
    icon: (
      <svg
  ...
  },
  {
    title: "Tags & filters",
    description:
      "Add tags to classNameify items. Search efficiently by type, tags, or domain.",
    image: "/images/tags-1056-867f09d12043fa86b6ea515184a8430b.png",
    imageSet:
      "/images/tags-1056-867f09d12043fa86b6ea515184a8430b.png 1056w,/images/tags-2112-ed8e6754be9ad4d522394abb39e1e662.png 2112w",
    link: "https://help.raindrop.io/tags",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="20"
  ...
  },
  {
    ...
    image: "/images/duplicates-1056-4d34a04c491d958d35959cf4725efd0f.png",
    imageSet:
    ...
    link: "https://help.raindrop.io/using-search#broken-links",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="20"
...
export const itemsData2: Item[] = [
  {
    ...
    image: "/images/highlights-1035-62c8216b75df6762172632e2f275ec86.png",
    imageSet:
    ...
    link: "https://help.raindrop.io/highlights",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="20"
  ...
  },
  {
    ...
    image: "/images/preview-1056-c9222c0ef24f1ba2c6864038e6735a6a.png 1056w",
    imageSet:
    ...
    link: "https://help.raindrop.io/bookmarks#preview",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="20"
  ...
  },
  {
    ...
    link: "https://help.raindrop.io/bookmarks#appearance",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="20"
...
export const itemsData3: Item[] = [
  ...
  },
  {
    ...
    image: "/images/backup-820-fda9e5ab41b90c201cb7fc3d7ebb585d.png",
    imageSet:
    ...
    link: "https://help.raindrop.io/backups#automatic",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="20"
...
export const itemsData4: Item[] = [
  {
    ...
    image: "/images/collaborate-1056-03d1d5b9578e0a1e700f300799078d8d.png",
    imageSet:
    ...
    link: "https://help.raindrop.io/collaboration",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="20"
  ...
  },
  {
    ...
    image: "images/public-1056-c56e4757a76d3135049c494b0cd73403.png",
    imageSet:
    ...
    link: "https://help.raindrop.io/public-page",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="20"
